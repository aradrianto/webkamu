  ...
  <div class="container-fluid" id="footer">
    <div class="row">
      ...
      <div class="col-xs-3 col-xs-offset-1 text-white">
        ...
        <hr>
        <a href="https://www.facebook.com/adri.anto" target="_blank"><img style="width: 40px; height: 40px; margin-right: 1vw;" src="asset/img/facebook.png"></a>
        ...
        <a href="https://www.instagram.com/adri.anto.3154284" target="_blank"><img style="width: 40px; height: 40px; margin-right: 1vw;" src="asset/img/instagram.png"></a>
